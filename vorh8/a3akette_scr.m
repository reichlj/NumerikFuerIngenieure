...
[t,y]=ode45(@a3akette_dgl,[0,50],y0);
% Ergebnis ausgeben Masse 1 darstellen
subplot(2,1,1)
plot(t,y(:,1),'LineWidth',1.5);
str=sprintf('x1=%.2f v1=%.2f c/m=%.2f',y0(1),y0(2),cm);
title(['Masse 1 : ',str])
% Masse 2 darstellen
subplot(2,1,2)
plot(t,y(:,3),'LineWidth',1.5);
str=sprintf('x2=%.2f v2=%.2f c/m=%.2f',y0(3),y0(4),cm);
title(['Masse 2 : ',str])
...
while(n <= length(t))
  ...
  plot([y(n,1)+1 y(n,3)+4],[0 0],'ro-','MarkerSize',30,'LINEWIDTH',3);
  hold on
  % Ruhelage zeichnen
